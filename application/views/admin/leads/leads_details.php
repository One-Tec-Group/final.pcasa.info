    ...
    <div class="col-sm-3">
        ...
        <ul class="nav nav-pills nav-stacked navbar-custom-nav">
            <li class="<?= $active == 1 ? 'active' : '' ?>">
                <a href="#task_details" data-toggle="tab"><?= lang('leads_details') ?></a>
            </li>
            <li class="<?= $active == 2 ? 'active' : '' ?>">
                <a href="#call" data-toggle="tab"><?= lang('call') ?>
                    <strong class="pull-right"><?= (!empty($all_calls_info) ? count($all_calls_info) : null) ?></strong>
                </a>
            </li>
            <li class="<?= $active == 3 ? 'active' : '' ?>">
              <a href="#mettings" data-toggle="tab"><?= lang('mettings') ?>
                    <strong class="pull-right"><?= (!empty($all_meetings_info) ? count($all_meetings_info) : null) ?></strong>
              </a>
            </li>
            <li class="<?= $active == 4 ? 'active' : '' ?>">
              <a href="#task_comments" data-toggle="tab"><?= lang('comments') ?>
                    <strong class="pull-right"><?= (!empty($comment_details) ? count($comment_details) : null) ?></strong>
                </a>
            </li>
            <li class="<?= $active == 5 ? 'active' : '' ?>">
                <a href="#task_attachments" data-toggle="tab"><?= lang('attachment') ?>
                    <strong class="pull-right"><?= (!empty($project_files_info) ? count($project_files_info) : null) ?></strong>
                </a>
            </li>
            <li class="<?= $active == 8 ? 'active' : '' ?>">
                <a href="#tasks" data-toggle="tab"><?= lang('tasks') ?>
                    <strong class="pull-right"><?= (!empty($all_task_info) ? count($all_task_info) : null) ?></strong>
                </a>
            </li>
            <li class="<?= $active == 8 ? 'active' : '' ?>">
                <a href="#proposals" data-toggle="tab"><?= lang('proposals') ?>
                    <strong class="pull-right"><?= (!empty($all_proposals_info) ? count($all_proposals_info) : null) ?></strong>
                </a>
            </li>
            <li class="<?= $url == 'reminder' ? 'active' : '' ?>">
                <a href="#reminder" data-toggle="tab" aria-expanded="false"><?= lang('reminder') ?>
                    <strong class="pull-right"><?= (!empty($notified_reminder) ? $notified_reminder : null) ?></strong>
                </a>
            </li>
            <li class="<?= $active == 6 ? 'active' : '' ?>">
                <a href="#activities" data-toggle="tab"><?= lang('activities') ?>
        ...
        <div class="tab-content" style="border: 0;padding:0;">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php
                            if (!empty($leads_details->lead_name)) {
                                echo ((!empty($leads_details->salutaiton)) ? $leads_details->salutaiton . '. ' : "") . $leads_details->lead_name;
                            }
                            ?>
                            <div class="pull-right ml-sm " style="margin-top: -6px">
                              <?php if (!empty($can_edit) && !empty($edited)) { ?>
                                  <a href="<?= base_url() ?>admin/leads/index/<?= $leads_details->leads_id ?>" class="btn-xs btn btn-primary" title="" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="fa fa-pencil-square-o"></i></a>
                              <?php } ?>
                                <a href="<?= base_url("admin/opportunities/leadConvert/" . $leads_details->leads_id); ?>" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#myModal_large" title="Convert to opportunity"><span class="fa fa-eercast"></span></a>
                                <a data-toggle="tooltip" data-placement="top" title="<?= $title ?>" href="<?= base_url() ?>admin/projects/<?= $url ?>" class="btn-xs btn btn-<?= $btn ?>"><i class="fa fa-thumb-tack"></i></a>
                    ...
                    <div class="panel-body row form-horizontal task_details">
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="form-control-static"><?php
                                $leads_details->mobile = ltrim($leads_details->mobile, '0');
                                ...
                                foreach ($phone_information as $single_phone) {
                                    if ((strlen($single_phone->calling_code) + 1) == strlen($single_phone->phone_code)) {
                                        if (substr($leads_details->mobile, 0, strlen($single_phone->calling_code)) === $single_phone->calling_code || substr($leads_details->mobile, 0, strlen($single_phone->phone_code)) === $single_phone->phone_code) {
                                            $d = new DateTime("now", new DateTimeZone($single_phone->time_zone));
                                            echo '<img class="img-rounded" src="' . base_url("assets/img/flags/" . $single_phone->flag) . '" style="margin-right: 10px;" height="20px"><i>' . $leads_details->mobile . '</i>';
                                ...
                                foreach ($phone_information as $single_phone) {
                                    if ((strlen($single_phone->calling_code) + 1) == strlen($single_phone->phone_code)) {
                                        if (substr($leads_details->phone2, 0, strlen($single_phone->calling_code)) === $single_phone->calling_code || substr($leads_details->phone2, 0, strlen($single_phone->phone_code)) === $single_phone->phone_code) {
                                            $d = new DateTime("now", new DateTimeZone($single_phone->time_zone));
                                            echo '<img class="img-rounded" src="' . base_url("assets/img/flags/" . $single_phone->flag) . '" style="margin-right: 10px;" height="20px"><i>' . $leads_details->phone2 . '</i>';
                                            echo '<small> (<i>' . $single_phone->long_name . '</i> - <i>Time: ' . $d->format("h:i A") . '</i>)</small>';
                                            break;
                                        }
                                    }
                        ...
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <div class="pull-left">
                                  <p class="form-control-static">
                                      <?php
                                      if (!empty($leads_details->email2)) {
                                          echo $leads_details->email2;
                                      }
                                      ?>
                                  </p>
                                </div>
                                ...
                                foreach ($phone_information as $single_phone) {
                                    if ((strlen($single_phone->calling_code) + 1) == strlen($single_phone->phone_code)) {
                                        if (substr($leads_details->phone3, 0, strlen($single_phone->calling_code)) === $single_phone->calling_code || substr($leads_details->phone3, 0, strlen($single_phone->phone_code)) === $single_phone->phone_code) {
                                            $d = new DateTime("now", new DateTimeZone($single_phone->time_zone));
                                            echo '<img class="img-rounded" src="' . base_url("assets/img/flags/" . $single_phone->flag) . '" style="margin-right: 10px;" height="20px"><i>' . $leads_details->phone3 . '</i>';
                                            echo '<small> (<i>' . $single_phone->long_name . '</i> - <i>Time: ' . $d->format("h:i A") . '</i>)</small>';
                                            break;
                                        }
                                    }
                        ...
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <div class="pull-left">
                                  <p class="form-control-static">
                                      <?php
                                      if (!empty($leads_details->email3)) {
                                          echo $leads_details->email3;
                                      }
                                      ?>
                                  </p>
                                </div>
                                ...
                                foreach ($phone_information as $single_phone) {
                                    if ((strlen($single_phone->calling_code) + 1) == strlen($single_phone->phone_code)) {
                                        if (substr($leads_details->phone4, 0, strlen($single_phone->calling_code)) === $single_phone->calling_code || substr($leads_details->phone4, 0, strlen($single_phone->phone_code)) === $single_phone->phone_code) {
                                            $d = new DateTime("now", new DateTimeZone($single_phone->time_zone));
                                            echo '<img class="img-rounded" src="' . base_url("assets/img/flags/" . $single_phone->flag) . '" style="margin-right: 10px;" height="20px"><i>' . $leads_details->phone4 . '</i>';
                                            echo '<small> (<i>' . $single_phone->long_name . '</i> - <i>Time: ' . $d->format("h:i A") . '</i>)</small>';
                                            break;
                                        }
                                    }
                        ...
                        <div class="form-group col-sm-12">
                                ...
                                <div class="pull-left">
                                  <p class="form-control-static">
                                      ...
                                      if (!empty($leads_details->lead_source_id)) {
                                        $source = $this->db->where('lead_source_id', $leads_details->lead_source_id)->get('tbl_lead_source')->row();
                            ...
                            <div class="col-sm-6">
                                ...
                                <p class="form-control-static">
                                    <?php
                                    if (!empty($leads_details->lead_category_id)) {
                                        $category = $this->db->where('lead_category_id', $leads_details->lead_category_id)->get('tbl_lead_category')->row();
                        ...
                        <div class="form-group col-sm-12">
                            ...
                            <div class="col-sm-6">
                                ...
                                <?php if (!empty($leads_details->skype)) { ?>
                                    <a href="skype:'<?= $leads_details->skype; ?>'"><p class="form-control-static"><?= $leads_details->skype; ?></p></a>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <div class="pull-left">
                                  <p class="form-control-static">
                                      <?php
                                      if (!empty($leads_details->fax)) {
                                          echo $leads_details->fax;
                                      }
                                      ?>
                                  </p>
                                </div>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <p class="form-control-static">
                                    <?php
                                    if (!empty($leads_details->date_of_birth)) {
                                        date("d-m-Y", strtotime($leads_details->date_of_birth));
                                    }
                                    ?>
                                </p>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <p class="form-control-static">
                                    <?php
                                    if (!empty($leads_details->passport_number)) {
                                        echo $leads_details->passport_number;
                                    }
                                    if (!empty($leads_details->passport_expire)) {
                                        echo ' - ' . date("d-m-Y", strtotime($leads_details->passport_expire));
                                    }
                                    ?>
                                </p>
                            </div>
                        ...
                        <div class="form-group col-sm-12">
                            <div class="col-sm-6">
                                ...
                                <?php if (!empty($leads_details->skype)) { ?>
                                    <a href="//'<?= $leads_details->facebook; ?>'"><p class="form-control-static"><?= $leads_details->facebook; ?></p></a>
                                <?php } ?>
                            </div>
                            <div class="col-sm-6">
                                <label class="control-label col-sm-5"><strong><?= lang('twitter_profile_link') ?>: </strong></label>
                                <?php if (!empty($leads_details->skype)) { ?>
                                    <a href="//'<?= $leads_details->twitter; ?>'"><p class="form-control-static"><?= $leads_details->twitter; ?></p></a>
                                <?php } ?>
                            </div>
                        </div>
                        <div class="form-group col-sm-12">
                                            ...
                                            if (!empty($can_edit) && !empty($edited)) {
                                                ?>
                                                    <span data-placement="top" data-toggle="tooltip" title="<?= lang('add_more') ?>">
                                                        <a data-toggle="modal" data-target="#myModal" href="<?= base_url() ?>admin/leads/update_users/<?= $leads_details->leads_id ?>" class="text-default ml"><i class="fa fa-plus"></i></a>
                                                    </span>
                                                </p>
                                            <?php
                                        }
                ...
                <div class="panel panel-custom">
                    <div class="panel-heading mb0">
                        ...
                        <h3 class="panel-title"><?= lang('attach_file_list') ?>
                            <a data-toggle="tooltip" data-placement="top" href="<?= base_url('admin/global_controller/download_all_attachment/leads_id/' . $leads_details->leads_id) ?>"
                            ...
                            <div class="pull-right hidden-print" style="padding-top: 0px;padding-bottom: 8px">
                                <a href="<?= base_url() ?>admin/leads/new_attachment/<?= $leads_details->leads_id ?>" class="text-purple text-sm" data-toggle="modal" data-placement="top"
                                                    ...
                                                    <table id="table-files" class="table table-striped ">
                                                        ...
                                                        <tbody>
                                                                    ...
                                                                    <tr class="file-item">
                                                                        <td data-toggle="tooltip" data-placement="top" data-original-title="<?= $files_info[$key]->description ?>">
                                                                            <?php if ($v_files->is_image == 1) : ?>
                                                                                <div class="file-icon"><a data-toggle="modal" data-target="#myModal_extra_lg" href="<?= base_url() ?>admin/leads/attachment_details/r/<?= $files_info[$key]->task_attachment_id . '/' . $v_files->uploaded_files_id ?>">
                                                                                        <img style="width: 50px;border-radius: 5px;" src="<?= base_url() . $v_files->files ?>"/></a>
                                                                                </div>
                                                                              <?php else : ?>
                                                                                <div class="file-icon"><i class="fa fa-file-o"></i>
                                                                                    <a data-toggle="modal" data-target="#myModal_extra_lg" href="<?= base_url() ?>admin/leads/attachment_details/r/<?= $files_info[$key]->task_attachment_id . '/' . $v_files->uploaded_files_id ?>"><?= $v_files->file_name ?></a>
                                                                                </div>
                                                                              <?php endif; ?>
                                                                        </td>
                                                                    ...
                                                                    <?= $user_info->username ?>
                                                                        ...
                                                                        <td>
                                                                            <a class="btn btn-xs btn-dark" data-toggle="tooltip" data-placement="top" title="Download" href="<?= base_url() ?>admin/leads/download_files/<?= $v_files->uploaded_files_id ?>"><i class="fa fa-download"></i></a>
                                                                        </td>
                                                                    </tr>
                                                                          <?php
                                                                      }
            ...
            <div class="tab-pane <?= $active == 8 ? 'active' : '' ?>" id="tasks"
                ...
                <div class="nav-tabs-custom ">
                    <!-- Tabs within a box -->
                    <ul class="nav nav-tabs">
                        <li class="<?= $sub_active == 1 ? 'active' : ''; ?>"><a href="#manageTasks" data-toggle="tab"><?= lang('all_task') ?></a></li>
                        <li class=""><a href="<?= base_url() ?>admin/tasks/all_task/leads/<?= $leads_details->leads_id ?>"><?= lang('new_task') ?></a></li>
                    </ul>
                    <div class="tab-content bg-white">
                        <!-- ************** general *************-->
            ...
            <div class="tab-pane <?= $active == 9 ? 'active' : '' ?>" id="proposals" style="position: relative;">
                <div class="nav-tabs-custom ">
                    <!-- Tabs within a box -->
                    <ul class="nav nav-tabs">
                        <li class="<?= $sub_active == 1 ? 'active' : ''; ?>"><a href="#manageProposals" data-toggle="tab"><?= lang('all_proposals') ?></a></li>
                        <li class=""><a href="<?= base_url() ?>admin/proposals/index/leads/<?= $leads_details->leads_id ?>"><?= lang('create_proposal') ?></a></li>
                    </ul>
                    <div class="tab-content bg-white">
                        <!-- ************** general *************-->
                                                ...
                                                if (!empty($all_proposals_info)) {
                                                    foreach ($all_proposals_info as $v_proposals) {
                                                        ...
                                                        <tr id="leads_proposals_<?= $v_proposals->proposals_id ?>">
                                                            ...
                                                            <?php if (strtotime($v_proposals->due_date) < strtotime(date('Y-m-d')) && $v_proposals->status == 'pending' || strtotime($v_proposals->due_date) < strtotime(date('Y-m-d')) && $v_proposals->status == ('draft')) { ?>
