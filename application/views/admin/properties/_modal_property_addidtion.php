<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        <form action="<?= base_url() ?>admin/properties/save_attachment" class="form-horizontal form-groups-bordered" role="form" method="post" enctype="multipart/form-data" accept-charset="utf-8" novalidate="novalidate">
            <div class="modal-body clearfix">
                <input type="hidden" name="property_id" value="" class="form-control">
                <div class="form-group">
                    <div class="col-sm-12">
                        <div id="file-dropzone" class="dropzone mb15"></div>
                            ...
                            <div id="file-previews" class="row">
                                <div id="file-upload-row" class="col-sm-6 mt file-upload-row">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <p class="clearfix mb0 p0"><span class="size" data-dz-size></span></p>
            ...
            <div class="modal-footer">
                ...
                <button id="file-save-property_btn" type="submit" disabled="disabled" class="btn btn-primary start-upload"><span class="fa fa-check-circle"></span> <?php echo lang('save'); ?></button>
            </div>
        </form>
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var projectFilesDropzone = new Dropzone("#file-dropzone", {
                    ...
                    processing: function () {
                        $("#file-save-property_btn").prop("disabled", true);
                    },
                    queuecomplete: function () {
                        $("#file-save-property_btn").prop("disabled", false);
                    },
                    fallback: function () {
