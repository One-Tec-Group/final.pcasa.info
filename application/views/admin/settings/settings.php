    ...
    <div class="col-lg-12">
        <div class="col-md-3">
            <ul class="nav nav-pills nav-stacked navbar-custom-nav">
                ...
                $can_do = can_do(158);
                if (!empty($can_do)) { ?>
                    <li class="<?php echo ($load_setting == 'proeprties_source') ? 'active' : ''; ?>">
                        <a href="<?= base_url() ?>admin/settings/properties_source">
                            <i class="fa fa-fw fa-arrow-down"></i>
                            <?php echo lang('proeprties_source') ?>
                        </a>
                    </li>
                <?php }
                $can_do = can_do(159);
                if (!empty($can_do)) { ?>
                    <li class="<?php echo ($load_setting == 'properties_type') ? 'active' : ''; ?>">
                        <a href="<?= base_url() ?>admin/settings/properties_type">
                            <i class="fa fa-fw fa-arrow-down"></i>
                            <?php echo lang('proeprties_type') ?>
                        </a>
                    </li>
                <?php }
                $can_do = can_do(129);
