...
define('MW_VERSION', '1.6.3'); // never remove or alter this constant, never!
...
// support forum.
defined('MW_SUPPORT_FORUM_URL') or define('MW_SUPPORT_FORUM_URL', 'https://www.onetecgroup.com/');

// support KB.
defined('MW_SUPPORT_KB_URL') or define('MW_SUPPORT_KB_URL', 'https://www.onetecgroup.com/');
